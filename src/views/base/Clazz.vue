...
=======
  <div style="width:100%">
    ...
    <el-row type="flex" class="ml-20 mt-10">
      <el-input v-model="input" clearable placeholder="请输入内容" class="blur-search" @input="filterSearch()"></el-input>
    ...
    <el-row>
      ...
      <el-col span="23" class="ml-20 mt-10">
        <el-table :data="clazzList" stripe="true" style="width: 100%;">
          <el-table-column type="selection" min-width="10%" @selection-change="handleSelectionChange"> </el-table-column>
          <el-table-column label="班级" show-overflow-tooltip min-width="13%">
            <template slot-scope="scope">
              <span>{{ scope.row.name }}</span>
            </template>
          </el-table-column>
          <el-table-column label="年级" show-overflow-tooltip min-width="13%">
            <template slot-scope="scope">
              <span>{{ scope.row.grade }}</span>
            </template>
          </el-table-column>
          <el-table-column label="班主任" show-overflow-tooltip min-width="12%">
            <template slot-scope="scope">
              <span>{{ scope.row.clazzHeadmaster }}</span>
            </template>
          </el-table-column>
...
>>>>>>> 5a62f0556b7da2ce6c1f6e33f437cd998f60120b
  </div>
</template>
