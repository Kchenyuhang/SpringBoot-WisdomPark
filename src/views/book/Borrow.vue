<template>
  <div class="container">
    ...
    <el-table ref="bookId" :data="borrowShow" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="borrowUserName" label="借阅人" width="130"> </el-table-column>
      <el-table-column prop="borrowUserPhone" label="联系方式" width="130"> </el-table-column>
      <el-table-column prop="isReturned" label="是否归还" width="130"> </el-table-column>
      <el-table-column prop="isDeleted" label="删除标志" width="130"> </el-table-column>
...
export default {
  ...
  methods: {
    async getAllBorrow() {
      ...
      // this.total = this.borrows.length - 1
