<template>
  <div style="width:100%">
    <!-- 增加弹出框 -->
    <el-dialog title="新增资讯类型信息" :visible.sync="addcenterDialogVisible" width="30%" center>
      <el-form :model="ruleForm" status-icon label-width="80px">
        <el-form-item label="分类名" prop="name">
          <el-input type="text" v-model="ruleForm.name" autocomplete="off" placeholder="请输入新增的分类名"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-row type="flex" class="ml-20 mt-10">
      ...
      <el-select v-model="selectValue" placeholder="请选择" size="mini" class="statu-search ml-10">
    ...
    <el-row>
      ...
      <el-col span="23" class="ml-20 mt-10">
        ...
        >
          ...
          <el-table-column label="分类名" show-overflow-tooltip min-width="15%">
            <template slot-scope="scope">
              <span>{{ scope.row.name }}</span>
            </template>
          </el-table-column>
          <el-table-column label="排序" show-overflow-tooltip min-width="15%">
            <template slot-scope="scope">
          ...
          <el-table-column label="操作" show-overflow-tooltip min-width="10%" align="center">
            <template slot-scope="scope">
