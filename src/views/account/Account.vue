        ...
        >
          ...
          <el-table-column prop="status" label="状态" show-overflow-tooltip min-width="15%">
            <template slot-scope="scope">
              <el-switch v-model="scope.row.statu" active-value="1" inactive-value="0" active-color="#13ce66" inactive-color="#ff4949"> </el-switch>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getSemesterAll() {
      this.userAccounts = (await API.init('/userAccount/all', this.pageDto, 'post')).data.content
